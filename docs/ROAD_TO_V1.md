...
|---|---|---|
| v0.9.5.139 | Gold Core Elimination Phase I | Convert Character ReOCR fragments into scored, explainable consensus evidence. |
| v0.9.5.139 | Multi-Crop Consensus | Generate multiple observations per weak glyph position and improve evidence coverage. |
...
| v0.9.5.139 | Gold Blocker Strike I | Clear the first narrow localized Latin glyph blocker under strict evidence guardrails. |
